...
%>
	...
	function onclickOfFacebookLogin(){
		...
		window.location.href='/adminLogin?emailId='+emailId+'&companyName='+companyName;
	}
</script>
<style type="text/css">
...
<div 	id="content">
    <div id="content_inner_wrapper"> <!-- controls the width of layout -->
        ...
        <div class="clear_all"></div>
	        ...
	        <center><div style="color: #555; margin-bottom: 12px; margin-left:-22px;margin-right:-20px;">Login With Your Google/Facebook Account </div></center>
