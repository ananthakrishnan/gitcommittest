$(document).ready(function() {
	...
	$('.video_popup_cancel_act').click(function() {
  		$('#backgroundPopup').fadeOut();
		$('.add_vid_link').hide();
		$('.add_vid_link1').hide();
	});
	...
	$(window).load(function () { 
		...
		$('.left_cont ul,.drag_list_cont').height(cal_height - 170);
		$('.left_cont').height(cal_height - 70);
		$('.right_cont').height(cal_height - 70);
		$('.dataTables_scrollBody').height(cal_height - 250);
		
		
	
		
//		$("#dbBadches,#dbTrophies").css("height","300px");
...
// black screen dynamic height on window resize
   ...
   var win_height = parseInt(document.documentElement.clientHeight) ;
	...
	$('.badge_act').live("click",function() {
		$(".badge_detail_col").find("code").fadeIn();	
		$(".badge_detail_col").find("code").removeClass('trophy_icon').addClass('badge_icon');
	 });
	$('.trophy_act').live("click",function() {
		$(".badge_detail_col").find("code").fadeIn();	
		$(".badge_detail_col").find("code").addClass('trophy_icon').removeClass('badge_icon');
	 });
	
	$('.library_cat').live("click",function() {
		$(".badge_detail_col").find("code").hide();	
		$(".badge_detail_col").find("code").removeClass("badge_icon").removeClass('trophy_icon');
	 });
