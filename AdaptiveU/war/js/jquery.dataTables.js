...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			nFilter.innerHTML = '<label style="position:relative;">'+sSearchStr+'</label>';
		...
		function _fnFeatureHtmlLength ( oSettings )
		{
			...
			nLength.innerHTML = '<label style="position:relative;">'+oSettings.oLanguage.sLengthMenu.replace( '_MENU_', sStdMenu )+'</label>';
